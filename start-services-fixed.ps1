...
# 停止现有进程
Write-Host ""
Write-Host "[1/5] 停止现有 Node.js 进程..." -ForegroundColor Yellow
...
# 检查并编译后端
Write-Host ""
Write-Host "[2/5] 检查并编译后端..." -ForegroundColor Yellow
...
# 启动后端
Write-Host ""
Write-Host "[3/5] 启动后端服务 (端口 3000)..." -ForegroundColor Yellow
...
# 启动前端
Write-Host ""
Write-Host "[4/5] 启动前端服务 (端口 5173)..." -ForegroundColor Yellow
...
# 启动代理
Write-Host ""
Write-Host "[5/5] 启动反向代理 (端口 80)..." -ForegroundColor Yellow
